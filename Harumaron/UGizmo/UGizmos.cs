...
namespace UGizmo
{
    ...
    public partial class UGizmos : IGlobalGizmos, IGlobalGizmoPrimitive, IGlobalGizmoPrimitive2D, IGlobalGizmoUtility, IGlobalGizmoArrow, IGlobalGizmoPhysics, IGlobalGizmoPhysics2D
    {
        ...
        private  readonly Color falseDarkColor = new Color(1f, 0.05f, 0.11f);
        private  readonly Color invalidColor = new Color(0.19f, 0.18f, 0.18f, 0.22f);
        private  readonly float pointRadius = 0.08f;
        private  readonly float alphaRate = 0.3f;
        ...
        public void DrawSphere(Vector3 center, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireSphere(Vector3 center, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireSphere(Vector3 center, Quaternion rotation, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCube(Vector3 center, Quaternion rotation, Vector3 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCube(Vector3 center, Quaternion rotation, Vector3 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCapsule(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCapsule(Vector3 center, Vector3 upAxis, float height, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCapsule(Vector3 point1, Vector3 point2, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCapsule(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCapsule(Vector3 center, Vector3 upAxis, float height, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCapsule(Vector3 point1, Vector3 point2, float radius, Color color, float duration = 0f)
        {
            float3 diff = point2 - point1;
            GizmoUtility.LengthAndNormalize(diff, out float length, out float3 normal);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCylinder(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCylinder(Vector3 point1, Vector3 point2, float radius, Color color, float duration = 0f)
        {
            float3 diff = point2 - point1;
            GizmoUtility.LengthAndNormalize(diff, out float length, out float3 normal);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCylinder(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCylinder(Vector3 point1, Vector3 point2, float radius, Color color, float duration = 0f)
        {
            float3 diff = point2 - point1;
            GizmoUtility.LengthAndNormalize(diff, out float length, out float3 normal);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCone(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCone(float3 origin, float3 direction, float distance, float angle, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCone(Vector3 position, Quaternion rotation, Vector3 scale, Color color, float duration = 0f)
        {
            float maxX = math.max(scale.x, scale.y) * 0.5f;
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireCone(float3 origin, float3 direction, float distance, float angle, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawPlane(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawWirePlane(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawCircle2D(Vector3 position, Quaternion rotation, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawCircle2D(Vector3 position, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawWireCircle2D(Vector3 position, Quaternion rotation, float radius, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate90X(rotation, out quaternion result);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawWireCircle2D(Vector3 position, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawBox2D(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate90X(rotation, out quaternion result);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawBox2D(Vector3 position, float angle, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireBox2D(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate90X(rotation, out quaternion result);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireBox2D(Vector3 position, float angle, Vector2 size, Color color, float duration = 0f)
        {
            GizmoUtility.PlaneToQuad(angle, out quaternion rotation);
            DrawWirePlaneCore(position, rotation, size, color, duration);
        }
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawTriangle2D(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawTriangle2D(Vector3 position, float angle, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireTriangle2D(Vector3 position, Quaternion rotation, Vector2 size, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireTriangle2D(Vector3 position, float angle, Vector2 size, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate2D(angle, out quaternion to);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawWireTriangle2D(Vector3 point1, Vector3 point2, Vector3 point3, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawCapsule2D(Vector3 center, Quaternion rotation, float height, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawCapsule2D(Vector3 center, float angle, float height, float radius, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate2D(angle, out quaternion to);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawWireCapsule2D(Vector3 center, Quaternion rotation, float height, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawWireCapsule2D(Vector3 center, float angle, float height, float radius, Color color, float duration = 0f)
        {
            GizmoUtility.Rotate2D(angle, out quaternion to);
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawPoint(Vector3 position, float radius, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public void DrawLine(Vector3 from, Vector3 to, Color color, float duration = 0f)
        {
        ...
        public  unsafe void DrawLineList(ReadOnlySpan<Vector3> points, Color color, float duration = 0f)
        {
        ...
        /// <param name="duration"></param>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        public  unsafe void DrawLineStrip(ReadOnlySpan<Vector3> points, bool loop, Color color, float duration = 0f)
        {
        ...
        [BurstCompile]
        private  unsafe void WriteLineBufferList_Burst(float3* points, LineData* destination, int count, float4* color)
        {
        ...
        [BurstCompile]
        private  unsafe void WriteLineBufferStrip_Burst(float3* points, LineData* destination, int count, bool loop, float4* color)
        {
        ...
        ///  <param name="color"></param>
        ///  <param name="duration"></param>
        public  void DrawRay(Vector3 from, Vector3 direction, Color color, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawRay(Ray ray, Color color, float duration = 0f)
        {
        ...
        public  void DrawFrustum(Camera camera, Color color, float duration = 0f)
        {
            if (camera == null)
            {
        ...
        /// <param name="duration"></param>
        public  void DrawDistance(Vector3 from, Vector3 to, Color color, float headLength = 0.5f, float headWidth = 0.3f, float duration = 0f)
        {
        ...
        /// <param name="color"></param>
        /// <param name="duration"></param>
        public  void DrawMeasure(Vector3 from, Vector3 to, float interval, Color color, float duration = 0f)
        {
            Camera camera = Camera.main;
            float3 a = from;
            float3 b = to;
        ...
        /// <param name="duration"></param>
        public void DrawArrow(Vector3 from, Vector3 to, Color color, float headLength = 0.5f, float width = 0.3f, float duration = 0f)
        {
        ...
        /// <param name="width"></param>
        /// <param name="duration"></param>
        public  void DrawFacingArrow2d(Vector3 from, Vector3 to, Color color, float headLength = 0.5f, float width = 0.3f, float duration = 0f)
        {
            Camera camera = Camera.main;
        ...
        /// <param name="headWidth"></param>
        /// <param name="duration"></param>
        public  void DrawFacingWireArrow(
            Vector3 from,
            Vector3 to,
            Color color,
            float headLength = 0.5f,
        ...
        /// <returns></returns>
        public bool Raycast(Vector3 origin,
            Vector3 direction,
            float maxDistance,
            int layerMask = -5,
        ...
        public void DrawRaycast(Vector3 origin, Vector3 direction, float maxDistance, bool isHit, in RaycastHit hitInfo)
        {
        ...
        /// <param name="isHit"></param>
        /// <param name="hitInfo"></param>
        public  void DrawSphereCast(Vector3 origin,
            float radius,
            Vector3 direction,
            float maxDistance,
            bool isHit,
        ...
        /// <param name="queryTriggerInteraction"></param>
        /// <returns></returns>
        public  bool BoxCast(Vector3 origin,
            Vector3 halfExtents,
            Vector3 direction,
        ...
        /// <param name="isHit"></param>
        /// <param name="hitInfo"></param>
        public  void DrawBoxCast(Vector3 origin,
            Vector3 halfExtents,
            Vector3 direction,
            Quaternion orientation,
            float maxDistance,
        ...
        /// <param name="isHit"></param>
        /// <param name="hitInfo"></param>
        public  void DrawCapsuleCast(Vector3 point1,
            Vector3 point2,
            float radius,
            Vector3 direction,
            float maxDistance,
        ...
        private  void DrawShapeCast(Vector3 origin, Vector3 direction, float maxDistance, bool isHit, in RaycastHit hitInfo, out Vector3 target)
        {
            Color color = isHit ? trueColor : falseColor;
        ...
        /// <param name="maxDepth"></param>
        /// <returns></returns>
        public  RaycastHit2D Linecast2D(
            Vector2 start,
            Vector2 end,
            float distance = float.PositiveInfinity,
            int layerMask = -1,
        ...
        /// <param name="maxDepth"></param>
        /// <returns></returns>
        public  RaycastHit2D CircleCast2D(
            Vector2 origin,
            float radius,
            Vector2 direction,
            float distance = float.PositiveInfinity,
        ...
        /// <param name="maxDepth"></param>
        /// <returns></returns>
        public  RaycastHit2D CapsuleCast2D(
            Vector2 origin,
            Vector2 size,
            float angle,
        ...
        private  ContactFilter2D CreateLegacyFilter(
            int layerMask,
            float minDepth,
            float maxDepth)
        {
