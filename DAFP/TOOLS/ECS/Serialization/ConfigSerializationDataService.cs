...
namespace DAFP.TOOLS.ECS.Serialization
{
    ...
    public class ConfigSerializationDataService : ISerializationDataService
    {
        public string GetFullSavePath(string domainName, string stateName, string name)
        {
            // 1. Build the relative save path
            var pathInfo = ISerializationDataService.ConstructSavePath(domainName, stateName, name);
        ...
        public void DeleteSave(string domainName, string stateName, string name)
        {
            ...
            var path = ISerializationDataService.ConstructSavePath(domainName, stateName, name);
