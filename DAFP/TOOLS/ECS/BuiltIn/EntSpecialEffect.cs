...
{
    public class EntSpecialEffect : Entity, IGamePoolable<EntSpecialEffect>, ISwitchable
    {
        ...
        public virtual EntSpecialEffect ResetObj()
        {
            return this;
        }

        public virtual EntSpecialEffect Get()
        {
            return this;
        }
