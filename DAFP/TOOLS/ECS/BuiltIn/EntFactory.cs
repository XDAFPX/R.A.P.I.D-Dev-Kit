...
namespace DAFP.TOOLS.ECS.BuiltIn
{
    ...
    {
        [field: SerializeField]protected override SerializableInterface<IAsyncFactory<IEnumerable<IEntity>>> Factory { get; set; }
    }
    
    public abstract class EntFactory : EmptyEntity, IAsyncFactory<IEnumerable<IEntity>>, IAsyncFactory<IEntity>
