...
namespace DAFP.TOOLS.ECS.Components.Movement
{
    ...
    public class Mover3D
        : MoverBase<Vector3, Rigidbody, ForceMode>
    {
        ...
        protected override void InternalAddForce(Vector3 f, ForceMode m)
        {
            Rb.AddForce(f, m);
        }
        ...
        protected override Vector3 FromIVector(IVector v)
        {
            V3 v3 = v.TryGetVector3();
            return (Vector3)v3;
        }

        protected override IVector ToIVector(Vector3 v)
        {
            return v.ToGeneric();
        }
    }
