...
namespace PixelRouge.Inspector
{
    ...
    public sealed class ButtonAttribute : PropertyAttribute
    {
        ...
        /// <param name="buttonMode">Changes when the button should be enabled.</param>
        public ButtonAttribute(string label, Color color, EButtonMode buttonMode = EButtonMode.AlwaysEnabled)
        {
            Label = label;
            Color =color;
            ButtonMode = buttonMode;
        ...
        /// <param name="buttonMode">Changes when the button should be enabled.</param>
        /// <param name="arguments">The parameters list of the method.</param>
        public ButtonAttribute(string label, Color color, EButtonMode buttonMode = EButtonMode.AlwaysEnabled, params System.Object[] arguments)
        {
            Label = label;
            Color = color;
            ButtonMode = buttonMode;
